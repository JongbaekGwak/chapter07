...
//	CellPhone의 필드인 model, color와 메서드인 powerOn, powerOff, bell, hangUp, sendVoice, receiveVoice 를 상속받음
//	DmbCellPhone은 상속받은 필드 및 메서드를 구현할 필요가 없음
//	구현하지 않아도 사용이 가능함
public class DmbCellPhone extends CellPhone {
//	String model; // 이렇게 새로 생성해도 상관없으나 이미 구현되어 있으므로 구현할 필요없음
//	String color;
	int channel;

	DmbCellPhone(String model, String color, int channel) {
//		부모 생성자 호출
//		컴파일러가 부모생성자를 호출하는 명령어 super() 를 자동 생성함
